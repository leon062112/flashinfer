...
Array<int64_t> BatchPrefillWithKVCachePlan(
    ...
    bool disable_split_kv, int64_t num_colocated_ctas, int64_t uniform_q_len, int64_t mask_mode,
    int64_t dllm_block_size, Optional<TensorView> q_offsets);
...
Array<int64_t> BatchPrefillWithKVCacheWorkspaceSize(
    ...
    int64_t num_colocated_ctas, int64_t uniform_q_len, int64_t mask_mode, int64_t dllm_block_size,
    Optional<TensorView> q_offsets);
